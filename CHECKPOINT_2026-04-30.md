...
```bash
bash stream.sh GT_videos/test_footage_40s_1080p_30fps.mp4 --debug
```
...
- SCPs pred mask to `Zappars@192.168.10.5:Documents/SAM-benchmark/pred_masks/`
...
- Automatically generates `tmp/mask_comparison.png` after every run
