...
# CBAM attention modules + projection layer for distillation
# just import CBAM and AttentionProjection into whatever distillation setup you have
...
class ChannelAttention(nn.Module):
    def __init__(self, channels, reduction=16):
        ...
        # avg and max paths share weights
...
class CBAM(nn.Module):
    # channel attention first, then spatial - ordering matters
...
class AttentionProjection(nn.Module):
    # 1x1 conv to map student channels into teacher space before the distill loss
