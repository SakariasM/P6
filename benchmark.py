...
Usage:
  python3 benchmark.py --gt gt_mask.mp4 --pred pred_mask.mp4
  python3 benchmark.py --gt gt_mask.mp4 --pred pred_mask.mp4 --log run_log.txt
  python3 benchmark.py --gt gt_mask.mp4 --pred pred_mask.mp4 --input raw.mp4 --output model_out.mp4
"""
import argparse
import datetime
import os
...
def main():
    ...
    log_path = "tmp/benchmark_log.txt"
    ...
    # ── comparison image ──────────────────────────────────────────────────────
    out_img = "tmp/mask_comparison.png"
